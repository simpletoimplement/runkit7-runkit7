...
runkit_function_redefine      : 3 to 6 args: ($funcname, $arglist_or_closure, $code_or_doc_comment, $return_by_reference, $doc_comment, $return_type)
runkit_function_remove        : 1 to 1 args: ($funcname)
runkit_function_rename        : 2 to 2 args: ($funcname, $newname)
runkit_method_add             : 3 to 7 args: ($classname, $methodname, $arglist_or_closure, $code_or_flags, $flags_or_doc_comment, $doc_comment, $return_type)
runkit_method_copy            : 3 to 4 args: ($dClass, $dMethod, $sClass, $sMethod)
runkit_method_redefine        : 3 to 7 args: ($classname, $methodname, $arglist_or_closure, $code_or_flags, $flags_or_doc_comment, $doc_comment, $return_type)
