...
runkit_method_copy            : 3 to 4 args: (string $destination_class, string $destination_method_name, string $source_class, ?string $source_method_name) (Deprecated)
runkit7_method_copy           : 3 to 4 args: (string $destination_class, string $destination_method_name, string $source_class, ?string $source_method_name)
...
runkit_method_rename          : 3 to 3 args: (string $class_name, string $source_method_name, string $target_method_name) (Deprecated)
runkit7_method_rename         : 3 to 3 args: (string $class_name, string $source_method_name, string $target_method_name)
