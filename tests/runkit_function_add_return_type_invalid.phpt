...
$retval = runkit7_function_add('runkit_function', 'string $a, $valid=false', 'return $valid ? $a : new stdClass();', false, '/** doc comment */', 'string#');
...
?>
--EXPECTF--
Warning: runkit7_function_add(): Return type should match regex %s in %s on line %d
